...
export const RECURRING_PAYMENT_SUCCESS = "RECURRING_PAYMENT_SUCCESS";
export const RECURRING_PAYMENT_FAILED = "RECURRING_PAYMENT_FAILED";
export const RECURRING_PAYMENT_SUMMARY = "RECURRING_PAYMENT_SUMMARY";
...
export type NotificationTypeKey =
  ...
  | typeof RECURRING_PAYMENT_SUCCESS
  | typeof RECURRING_PAYMENT_FAILED
  | typeof RECURRING_PAYMENT_SUMMARY;
